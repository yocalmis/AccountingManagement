...
//1 cari borçlandır
 ...
 public function cari_toplam_getir_sondurum($id, $kul_id,$satir)
    ...
    public function fat_kayit($fat_turu, $ara_toplam, $indirim, $vergi, $toplam, $mus, $seri, $no, $duz_ta, $va_ta, $ack, $irs_durum, $fat_turu, $kul_id, $per)
    {
    ...
    public function iade_fat_kayit($fat_id, $fat_turu, $ara_toplam, $indirim, $vergi, $toplam, $mus, $seri, $no, $duz_ta, $va_ta, $ack, $irs_durum, $fat_turu, $kul_id)
    {
    ...
    public function fat_guncelle($fat_id, $fat_turu, $ara_toplam, $indirim, $vergi, $toplam, $mus, $seri, $no, $duz_ta, $va_ta, $ack, $irs_durum, $kul_id)
    {
    ...
    public function islem_gunc_fat($fat_id, $is_t, $rel_t, $fat_id, $gir_cik, $toplam, $duz_ta, $ack, $mus, $kul_id)
    {
 ...
 */
    ...
    public function sip_kayit($fat_turu, $ara_toplam, $indirim, $vergi, $toplam, $mus, $seri, $no, $duz_ta, $va_ta, $ack, $irs_durum, $fat_turu, $kul_id)
    {
    ...
    public function tek_kayit($fat_turu, $ara_toplam, $indirim, $vergi, $toplam, $mus, $seri, $no, $duz_ta, $va_ta, $ack, $irs_durum, $fat_turu, $kul_id)
    {
